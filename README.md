...
| 6      | Machine learning fundamentals  | <a href='slides/6_ML_2026.pdf'>slides</a> + <a href='notebooks/6_1_LinearModels.ipynb'>notebook</a> (<a href="notebooks/7_2_PyTorch.ipynb">PyTorch</a>, advanced) |
| 7      | RNNs to Transformers, NER | slides + <a href='notebooks/8_2_NER_Transformers.ipynb'>NER (Transformers)</a>, <a href='notebooks/8_1_NER_PyTorch.ipynb'>NER (PyTorch)</a> |
